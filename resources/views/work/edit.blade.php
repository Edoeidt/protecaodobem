...
@section('main')
    <div class="row">
        <div class="col-sm-8 offset-sm-2">
            <h1 class="display-3">Atualizar Mão de Obra</h1>
            ...
            @if ($errors->any())
                ...
                <br />
            @endif
            <form method="post" action="{{ route('work.update', $person->id) }}">
                @method('PATCH')
                @csrf
                ...
                <div class="form-group">
                    <label for="job_title">Tipo Mão de Obra</label>
                    <input type="text" class="form-control" name="work" value={{ $person->work}} />
                </div>
